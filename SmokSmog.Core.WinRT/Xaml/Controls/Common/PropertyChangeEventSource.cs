...
namespace SmokSmog.Xaml.Controls.Common
{
        ...
        : FrameworkElement
    {
        ...
        /// <summary>
        /// Gets or sets the Value property. This dependency property indicates the value.
        /// </summary>
            ...
            BindingMode bindingMode = BindingMode.TwoWay)
        {
            ...
            // Bind to the property to be able to get its changes relayed as events throug the
            // ValueChanged event.
            var binding =
                new Binding
                {
