// Credits to Joost van Schaik who created the original WinRT Behaviors. This namespace is based on
// his work. It was however highly modified and is based on both his library and the API of
// Silverlight's Interactivity namespace.
...
{
    /// <summary>
    /// Static class that owns the Behaviors attached properties. Handles propagation of
    /// AssociatedObject change notifications.
    /// </summary>
    public static class Interaction
    {
        ...
        public static readonly DependencyProperty BehaviorsProperty =
            DependencyProperty.RegisterAttached("Behaviors", typeof(BehaviorCollection), typeof(Interaction),
                new PropertyMetadata(DesignMode.DesignModeEnabled ? new BehaviorCollection() : null, BehaviorsChanged));
        ...
        /// <returns>
        /// A <see cref="BehaviorCollection"/> containing the behaviors associated with the
        /// specified object.
        /// </returns>
