...
namespace SmokSmog
{
    ...
    public sealed partial class App : Application
    {
        ...
        // // Do not repeat app initialization when the Window already has content, just ensure that
        // // the window is active if (rootFrame == null) { // Create a Frame to act as the
        // navigation context and navigate to the first page rootFrame = new Frame();

        // // TODO: change this value to a cache size that is appropriate for your application
        // rootFrame.CacheSize = 1;

        // if (e.PreviousExecutionState == ApplicationExecutionState.Terminated) { // TODO: Load
        // state from previously suspended application }

        // // Place the frame in the current Window Window.Current.Content = rootFrame; }

        // if (rootFrame.Content == null) { // Removes the turnstile navigation for startup. if
        // (rootFrame.ContentTransitions != null) { this.transitions = new TransitionCollection();
        // foreach (var c in rootFrame.ContentTransitions) { this.transitions.Add(c); } }

        // rootFrame.ContentTransitions = null; rootFrame.Navigated += this.RootFrame_FirstNavigated;
        ...
        // if (!rootFrame.Navigate(typeof(MainPage), e.Arguments)) { throw new Exception("Failed to
        // create initial page"); } }
